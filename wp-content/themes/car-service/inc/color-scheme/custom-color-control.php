...
// css
  $car_service_hide_categorysec = get_theme_mod( 'car_service_hide_categorysec', false);
  if($car_service_hide_categorysec == false){
    $car_service_color_scheme_css .='.page-template-template-home-page .header{';
      $car_service_color_scheme_css .='position:static;';
    $car_service_color_scheme_css .='}';
    $car_service_color_scheme_css .='.ser-heading{';
      $car_service_color_scheme_css .='margin-top:0;';
    $car_service_color_scheme_css .='}';
  }