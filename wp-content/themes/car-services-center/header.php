...
<a class="screen-reader-text skip-link" href="#content"><?php esc_html_e( 'Skip to content', 'car-services-center' ); ?></a>
      ...
      <div class="col-lg-9 col-md-6 align-self-center">
        <div class="toggle-nav">
          <?php if(has_nav_menu('primary')){ ?>
            <button role="tab"><?php esc_html_e('MENU','car-services-center'); ?></button>
          <?php }?>
        </div>
        <div id="mySidenav" class="nav sidenav align-self-center">
          <nav id="site-navigation" class="main-nav" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu','car-services-center' ); ?>">
            <?php if(has_nav_menu('primary')){
              wp_nav_menu( array( 
            ...
            <a href="javascript:void(0)" class="close-button"><?php esc_html_e('CLOSE','car-services-center'); ?></a>
          </nav>
        </div>
      </div>
    </div>
