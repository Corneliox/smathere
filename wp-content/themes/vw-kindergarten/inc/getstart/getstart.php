...
function vw_kindergarten_gettingstarted() {
	add_theme_page( esc_html__('About VW Kindergarten', 'vw-kindergarten'), esc_html__('About VW Kindergarten', 'vw-kindergarten'), 'edit_theme_options', 'vw_kindergarten_guide', 'vw_kindergarten_mostrar_guide');
}
...
<div class="wrapper-info">
    ...
    <div class="col-right">
		...
		<div class="update-now">
			<h4><?php esc_html_e('Buy VW Kindergarten at 20% Discount','vw-kindergarten'); ?></h4>
    ...
    <div class="tab-sec">
    	<div class="tab">
			...
			<button class="tablinks" onclick="vw_kindergarten_open_tab(event, 'theme_pro')"><?php esc_html_e( 'Get Premium', 'vw-kindergarten' ); ?></button>
		  	<button class="tablinks" onclick="vw_kindergarten_open_tab(event, 'free_pro')"><?php esc_html_e( 'Support', 'vw-kindergarten' ); ?></button>
		</div>
			...
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($vw_kindergarten_plugin_custom_css); ?>">
				<div class="block-pattern-img">
					...
					<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','vw-kindergarten'); ?></p>
	              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon >> Click Pattern Tab >> Click on homepage sections >> Publish.','vw-kindergarten'); ?></span></b></p>
		...
		<div id="free_pro" class="tabcontent">
		  	<div class="col-3">
		  		<h4><span class="dashicons dashicons-star-filled"></span><?php esc_html_e('Pro Version', 'vw-kindergarten'); ?></h4>
				<p> <?php esc_html_e('To gain access to extra theme options and more interesting features, upgrade to pro version.', 'vw-kindergarten'); ?></p>
				<div class="info-link">
					<a href="<?php echo esc_url( VW_KINDERGARTEN_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Get Pro', 'vw-kindergarten'); ?></a>
				</div>
		  	</div>
		  	<div class="col-3">
		  		<h4><span class="dashicons dashicons-cart"></span><?php esc_html_e('Pre-purchase Queries', 'vw-kindergarten'); ?></h4>
				<p> <?php esc_html_e('If you have any pre-sale query, we are prepared to resolve it.', 'vw-kindergarten'); ?></p>
				<div class="info-link">
					<a href="<?php echo esc_url( VW_KINDERGARTEN_CONTACT ); ?>" target="_blank"><?php esc_html_e('Question', 'vw-kindergarten'); ?></a>
				</div>
		  	</div>
		  	<div class="col-3">		  		
		  		<h4><span class="dashicons dashicons-admin-customizer"></span><?php esc_html_e('Child Theme', 'vw-kindergarten'); ?></h4>
				<p> <?php esc_html_e('For theme file customizations, make modifications in the child theme and not in the main theme file.', 'vw-kindergarten'); ?></p>
				<div class="info-link">
					<a href="<?php echo esc_url( VW_KINDERGARTEN_CHILD_THEME ); ?>" target="_blank"><?php esc_html_e('About Child Theme', 'vw-kindergarten'); ?></a>
				</div>
		  	</div>

		  	<div class="col-3">
		  		<h4><span class="dashicons dashicons-admin-comments"></span><?php esc_html_e('Frequently Asked Questions', 'vw-kindergarten'); ?></h4>
				<p> <?php esc_html_e('We have gathered top most, frequently asked questions and answered them for your easy understanding. We will list down more as we get new challenging queries. Check back often.', 'vw-kindergarten'); ?></p>
				<div class="info-link">
					<a href="<?php echo esc_url( VW_KINDERGARTEN_FAQ ); ?>" target="_blank"><?php esc_html_e('View FAQ','vw-kindergarten'); ?></a>
				</div>
		  	</div>

		  	<div class="col-3">
		  		<h4><span class="dashicons dashicons-sos"></span><?php esc_html_e('Support Queries', 'vw-kindergarten'); ?></h4>
				<p> <?php esc_html_e('If you have any queries after purchase, you can contact us. We are eveready to help you out.', 'vw-kindergarten'); ?></p>
				<div class="info-link">
					<a href="<?php echo esc_url( VW_KINDERGARTEN_SUPPORT ); ?>" target="_blank"><?php esc_html_e('Contact Us', 'vw-kindergarten'); ?></a>
				</div>
		  	</div>
		</div>
